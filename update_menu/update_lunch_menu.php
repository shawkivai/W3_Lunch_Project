...
<div class="container">
    ...
    <div class="row update_menu">
        <div class="col-md-3 drop_menu">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="update_snacks_menu.php">Snacks</a></li>
        ...
        <div class="col-md-9 form_edit">
            <form action="../update_lunch_db.php" id="" method="post" enctype="multipart/form-data">
