        ...
        <div class="col-md-3 drop_menu">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="update_lunch_menu.php">Lunch</a></li>
                </ul>
            </div>
        </div>

        <div class="col-md-9 form_edit">
            <form action="../update_snacks_db.php" id="" method="post" enctype="multipart/form-data">
